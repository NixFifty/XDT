 ...
 */
abstract class XDT_CLI_Abstract
{
    ...
    {
        $forwardClass = new XDT_CLI_XenForo(false);
    ...
    /**
     * Outputs a string of text. Generally what will be used most times.
     *
     * @param $message
     * @param bool $newLine
     */
    ...
    /**
     * Alias for printMessage. Deprecated.
     *
     * @param $message
     * @param bool $newLine
     */
    ...
    /**
     * Alias for printMessage.
     *
     * TODO: format debug messages like debug messages...
     *
     * @param $message
     * @param bool $newLine
     */
    ...
    /**
     * Colorize text to make pretty things.
     *
     * @param $text
     * @param string $color
     * @return string
    ...
    public function bail($error, $type = 'ERROR')
    {
        ...
        {
            echo $this->colorText($type . ': ', self::RED) . $error;
            die();
        }
    }
    ...
    public function _run()
    {
        ...
        else
        {
            ...
            if (!method_exists($this, $method) OR $this->hasFlag('help') OR $this->hasFlag('h'))
            {
                $this->showHelp(true);
            }
