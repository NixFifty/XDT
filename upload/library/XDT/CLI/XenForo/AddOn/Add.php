 ...
 * Add a new addon
 */
class XDT_CLI_XenForo_Addon_Add extends XDT_CLI_Abstract
{
	protected $_help = '
	...
	public function run($addonName)
	{
		...
		//XDT_CLI_Application::writeConfig(array("addon" => $addon), $base . $addon->path . DIRECTORY_SEPARATOR . '.xfcli-config');
